...
function App() {
  const source = "segunda-guerra-mundial";
  ...
  useMemo(async () => {
    const newContent = await loadContent(source);
          ...
          >
            ...
            {!summary && (
              <Panel header="Sumário">
                <p>
                  Pressione o botão abaixo para gerar um sumário do texto atual.
                </p>
                <div className="flex mt-4 justify-end">
                  <button
                    className="p-button p-component p-button-outlined"
                    onClick={async () => {
                      const newSummary = await summarizeContent(content.source);
